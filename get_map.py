...
GT_PATH = os.path.join(os.getcwd(), 'fpn_ASGD_input', 'ground-truth')
DR_PATH = os.path.join(os.getcwd(), 'fpn_ASGD_input', 'detection-results')
IMG_PATH = os.path.join(os.getcwd(), 'fpn_ASGD_input', 'images-optional')
...
results_files_path = "results_fpn_ASGD"
...
for class_index, class_name in enumerate(gt_classes):
    ...
    for txt_file in dr_files_list:
        ...
        for line in lines:
            try:
                tmp_class_name, confidence, left, top, right, bottom, _ = line.split()
            except:
                line_split = line.split()
                bottom = line_split[-1]
                right = line_split[-2]
